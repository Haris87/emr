...
.controller('DietCtrl', function($scope, $stateParams, $location, $ionicModal, $ionicPopup) {
  ...
  $scope.diet = {};
  $scope.diet.date = new Date();//.toJSON().slice(0,10);
  ...
  $scope.getMeasurements = function(){
    ...
    db.query('index_diet/object').then(function (res) {
      console.log(res);
  ...
  $scope.insertDiet = function(diet){
    diet.date = new Date(diet.date);
    diet.type = "diet";
    db.post(diet).then(function(response) {
  ...
  $ionicModal.fromTemplateUrl('diet-modal.html', {
    scope: $scope,
