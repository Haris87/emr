...
.controller('SmokingCtrl', function($scope, $stateParams, $location, $ionicModal, $ionicPopup) {
  ...
  $scope.smoking = {};
  $scope.smoking.date = new Date();//.toJSON().slice(0,10);
  ...
  $scope.getMeasurements = function(){
    ...
    db.query('index_smoking/object').then(function (res) {
      console.log(res);
  ...
  $scope.insertSmoking = function(smoking){
    smoking.date = new Date(smoking.date);
    smoking.type = "smoking";
    db.post(smoking).then(function(response) {
  ...
  $ionicModal.fromTemplateUrl('smoking-modal.html', {
    scope: $scope,
