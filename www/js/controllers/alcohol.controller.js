...
.controller('AlcoholCtrl', function($scope, $stateParams, $location, $ionicModal, $ionicPopup) {
  ...
  $scope.alcohol = {};
  $scope.alcohol.date = new Date();//.toJSON().slice(0,10);
  ...
  $scope.getMeasurements = function(){
    ...
    db.query('index_alcohol/object').then(function (res) {
      console.log(res);
  ...
  $scope.insertAlcohol = function(alcohol){
    alcohol.date = new Date(alcohol.date);
    alcohol.type = "alcohol";
    db.post(alcohol).then(function(response) {
  ...
  $ionicModal.fromTemplateUrl('alcohol-modal.html', {
    scope: $scope,
